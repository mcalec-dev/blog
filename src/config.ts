...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    {
      name: 'Main Site',
      url: 'https://www.mcalec.dev/',     // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
  avatar: '/image/mcalec.png',  // Relative to the /src directory. Relative to the /public directory if it starts with '/'
  name: 'McAlec',
  bio: 'i am developer.',
  links: [
    {
      ...
      url: 'https://github.com/mcalec1',
    },
	{
      name: 'Bluesky',
      icon: 'fa6-brands:bluesky',
      url: 'https://bsky.app/profile/mcalec.dev',
    },
    {
      name: 'Discord',
